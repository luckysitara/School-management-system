...
class ReportCardDeleteView(LoginRequiredMixin, DeleteView):
    model = ReportCard
    template_name = 'academic/reportcard_confirm_delete.html'
    success_url = reverse_lazy('reportcard-list')
